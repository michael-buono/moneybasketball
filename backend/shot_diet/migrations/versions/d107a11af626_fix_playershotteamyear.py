...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["team_id"], ["team.team_id"], name="fk_player_shot_team_year_team_id"
        ),
        sa.ForeignKeyConstraint(
            ["player_id"],
            ["player.PLAYER_ID"],
            name="fk_player_shot_team_year_player_id",
        ),
    ...
    op.execute(
        "INSERT INTO player_shot_team_year_tmp SELECT id, player_id, team_id, season_year, is_current_season, created_at, updated_at, player_shot_career_id, empty FROM player_shot_team_year"
    )
