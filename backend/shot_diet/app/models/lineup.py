...
class Lineup(db.Model):
    ...
    players = db.relationship('Player', secondary='lineup_player_association', back_populates='lineups')
    lineup_player_association = db.Table('lineup_player_association',
    ...
    def setup_player_relationships(self):
        player_ids = [int(player_id) for player_id in self.GROUP_ID.split('-')[1:-1] if player_id != '']
